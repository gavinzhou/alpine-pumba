...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-pumba:${tag}" "asia.gcr.io/orange-sys/alpine-pumba:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-pumba:${tag}
